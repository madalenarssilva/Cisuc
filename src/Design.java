...
class Design extends Tarefa{
     ...
     */
    public Design(String dataInicio, int percentagemConclusao, String dataFim, Pessoa responsavel, long duracaoEstimada) {
     ...
     * @param duracaoEstimada
     */
    public Design(String dataInicio, int percentagemConclusao, String dataFim, long duracaoEstimada) {
